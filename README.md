...
* 장바구니 담는 화면 (/main/detail)
  - [ ] 장바구니 담기 버튼 활성화, 서버로 데이터 전송
  - [ ] 장바구니 버튼 css 수정
* 장바구니 기능 (/main/cart)
  - [ ] 장바구니 모듈 만들기 (물건 담기, 상품 수량 증가, 상품 수량 감소, 상품 삭제)
  - [ ] 장바구니 화면 css 수정 및 ejs 수정
  - [ ] 세션으로 장바구니 담긴 물건 관리함
  - [ ] 장바구니 아이콘을 누르면 장바구니 화면(cart.ejs)으로 이동
  - [ ] 장바구니 담기 버튼을 누르면 아이콘 옆에 몇 종류가 담겼는지 수량 체크
  - [ ] 장바구니 모듈과 서버 연동
